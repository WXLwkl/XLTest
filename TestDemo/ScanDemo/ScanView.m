...
//扫码区域各种参数
@property (nonatomic, strong,nullable) ScanViewStyle *viewStyle;
//扫码区域
@property (nonatomic,assign) CGRect scanRetangleRect;
//网格扫码动画封装
@property (nonatomic,strong,nullable) ScanNetAnimation *scanNetAnimation;
//线条在中间位置，不移动
...
- (void)startScanAnimation
{
    ...
    {
        case ScanViewAnimationStyle_LineMove:
        {
            
        }
            break;
        case ScanViewAnimationStyle_NetGrid:
        {
            //网格动画
            ...
            break;
        case ScanViewAnimationStyle_LineStill:
        {
            if (!_scanLineStill) {
...
- (void)drawScanRect
{
    ...
    {
        case ScanViewPhotoframeAngleStyle_Outer:
        {
            diffAngle = linewidthAngle/3;//框外面4个角，与框紧密联系在一起
        }
            break;
        case ScanViewPhotoframeAngleStyle_On:
        {
            diffAngle = 0;
        }
            break;
        case ScanViewPhotoframeAngleStyle_Inner:
        {
