...
+ (CALayer *)replicatorLayer_Circle{
    ...
    animationGroup.animations = @[[XLAnimation alphaAnimation],[XLAnimation scaleAnimation]];
...
+ (CALayer *)replicatorLayer_Wave{
    ...
    shape.fillColor = [UIColor redColor].CGColor;
    [shape addAnimation:[XLAnimation scaleAnimation1] forKey:@"scaleAnimation"];
...
+ (CALayer *)replicatorLayer_Triangle{
    ...
    shape.fillColor = [UIColor redColor].CGColor;
    shape.lineWidth = 1;
    [shape addAnimation:[XLAnimation rotationAnimation:transX] forKey:@"rotateAnimation"];
...
+ (CALayer *)replicatorLayer_Grid{
    ...
    CAAnimationGroup *animationGroup = [CAAnimationGroup animation];
    animationGroup.animations = @[[XLAnimation scaleAnimation1], [XLAnimation alphaAnimation]];
